        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-20 mb-16">
          ...
          <div className="w-full md:w-2/3">
            <p className="text-lg md:text-xl leading-relaxed mb-8">
              Violet Orb is a conceptual art project exploring the intersection of organic forms and digital manipulation. The project aims to challenge perceptions of reality and artifice through surrealist imagery.
            </p>
            ...
            <p className="mb-8">
              For this project, I am violet orb
            </p>
